...
def _print_banner(gateway: str) -> None:
    ...
    # ── Hermes 金色系葫芦 ASCII（约18列 × 8行）───────────────────────────
    # 借鉴 Hermes 流线语言：╭╮╰╯ 圆角 + ◠弧线 + ≋波浪
    # 配色：Hermes 金色系
    _GOLD   = "\033[38;5;220m"
    _DKGOLD = "\033[38;5;172m"
    _BROWN  = "\033[38;5;131m"
    _GREEN  = "\033[38;5;34m"
    _X      = "\033[0m"

    def _g(s): return f"{_GOLD}{s}{_X}"
    def _d(s): return f"{_DKGOLD}{s}{_X}"
    def _b(s): return f"{_BROWN}{s}{_X}"
    def _f(s): return f"{_GREEN}{s}{_X}"
